...
- Cần yêu cầu AI chấm mức Đạo Văn linh hoạt (Có trả về các mức dưới ngưỡng 25% như 5%, 10%, 15% mà không mặc định từ chối). Cụ thể hóa lỗi:
  1. Lỗi chính tả, đánh máy, dấu câu (Bắt buộc dùng Nghị định 30/2020/NĐ-CP làm căn cứ xét lỗi chính tả).
  2. Đánh giá đạo văn theo 2 mốc mới: <= 20% (Đạt, từ 6.0 trở lên); >= 21% (Không Đạt, từ 5.9 trở xuống).
  ...
  6. Áp dụng quy tắc viết "i" và "y" theo Quyết định 240 và Quyết định 1989/QĐ-BGDĐT: Ưu tiên dùng "i" (kỉ niệm, lí do, hi sinh, bác sĩ), chỉ dùng "y" khi đứng một mình, đứng sau âm đệm "u", nguyên âm "iê" đứng đầu tiếng. Bắt lỗi các từ dùng "y" sai chuẩn sư phạm.
